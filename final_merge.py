...
merged_df = orders_df.join(users_df, orders_df.customer_id == users_df.user_id, how='inner')

# Join with products data on product_name
merged_df = merged_df.join(products_df, merged_df.product_name == products_df.product_name, how='inner')
